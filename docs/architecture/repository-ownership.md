...
| `hara-lang/hara-play` | Hosted reference Hara Dev distribution, examples, learning activities and application-specific GitHub import | Canonical Workspace semantics or duplicate reusable Dev component implementations after migration |
